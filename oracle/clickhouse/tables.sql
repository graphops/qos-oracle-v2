...
SETTINGS
    ...
    kafka_schema = '/etc/clickhouse-server/schema.proto:qos.ClientQueryProtobuf';
...
SELECT
    ...
    response_bytes,
    total_fees_usd,
    indexer_queries.indexer,
    indexer_queries.deployment,
    indexer_queries.allocation,
    indexer_queries.indexed_chain,
    indexer_queries.url,
    indexer_queries.fee_grt,
    indexer_queries.response_time_ms,
    indexer_queries.seconds_behind,
    indexer_queries.result,
    indexer_queries.indexer_errors,
    indexer_queries.blocks_behind
FROM kafka_qos_data;
